...
def Diabetes_Result(request):
    if predicted_value:
        result = "Sorry your chances of getting the disease. Please consult the doctor immediately DDD"
    else:
        result = "No need to fear. You have no dangerous symptoms of the disease DDD"
