...
Model_path = "E:\Python in Sublime\DJango Framework\Carouselslider\Slider\Kidney\model\kidney_model.pkl"
...
def Kidney_Result(request):
    if predicted_value:
        result = "Sorry your chances of getting the disease. Please consult the doctor immediately KKK"
    else:
        result = "No need to fear. You have no dangerous symptoms of the disease KKK"
