...
def Heart(request):
    if request.method == 'POST':
        ...
        heart_form = Heart_Form()
    return render(request,template_name='hear.html',context={"heart_form":heart_form})



def Heart_Result(request):
    if predicted_value:
        result = "Sorry, your chances of getting the disease are high. Please consult the doctor immediately. HHH"
    else:
        result = "No need to fear. You have no dangerous symptoms of the disease HHH"
