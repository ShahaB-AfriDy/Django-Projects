...
Model_path = "E:\Python in Sublime\DJango Framework\Carouselslider\Slider\Liver\model\liver_model.pkl"
...
def Liver_Result(request):
    if predicted_value:
        result = "Sorry your chances of getting the disease. Please consult the doctor immediately LLL"
    else:
        result = "No need to fear. You have no dangerous symptoms of the disease LLL"
